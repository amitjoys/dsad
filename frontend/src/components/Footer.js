        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-xl font-bold">ConstructPune</h3>
                <p className="text-gray-400 text-sm">Since 2018</p>
              </div>
            </div>
            <p className="text-gray-400 leading-relaxed">
              ConstructPune is a trusted name in the construction industry, offering top-quality 
              residential, commercial, and industrial construction services in Pune and surrounding areas.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                <WrenchScrewdriverIcon className="h-4 w-4 text-primary-400" />
                <span className="text-gray-400">Simple Construction</span>
              </li>
              <li className="flex items-center space-x-2">
                <WrenchScrewdriverIcon className="h-4 w-4 text-primary-400" />
                <span className="text-gray-400">Luxury Construction</span>
              </li>
              <li className="flex items-center space-x-2">
                <WrenchScrewdriverIcon className="h-4 w-4 text-primary-400" />
                <span className="text-gray-400">Premium Experience</span>
              </li>
              <li className="flex items-center space-x-2">
                <CalculatorIcon className="h-4 w-4 text-primary-400" />
                <span className="text-gray-400">Cost Calculator</span>
              </li>
              <li className="flex items-center space-x-2">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+91-1234567890" className="text-gray-400 hover:text-primary-400 transition-colors">
                  +91-1234567890
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <EnvelopeIcon className="h-5 w-5 text-primary-400" />
                <a href="mailto:info@constructpune.in" className="text-gray-400 hover:text-primary-400 transition-colors">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} ConstructPune. All rights reserved.
            </div>
